...
**Files:**
- Create: `src/axiomrl/models/mlp_qr_q_network.py`
- Create: `src/axiomrl/algorithms/qr_dqn.py`
...
Add `class QRDQN(ManagedAlgorithm)` with `algo_name = "qr_dqn"`, and export via `axiomrl.api` and `axiomrl` top-level.
