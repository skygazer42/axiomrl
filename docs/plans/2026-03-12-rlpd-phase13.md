...
**Tech Stack:** Python, PyTorch, Gymnasium, existing `axiomrl` offline dataset, replay buffer, callback, and experiment infrastructure
...
**Files:**
- Create: `src/axiomrl/algorithms/rlpd.py`
...
**Files:**
- Create: `src/axiomrl/runtime/rlpd_trainer.py`
...
- Create: `src/axiomrl/assets/configs/rlpd/pendulum.yaml`
- Modify: `README.md`
