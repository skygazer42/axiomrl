    ...
    def __init__(
        ...
        *,
        ...
        if len(self.obs_shape) != 3:
            raise ValueError(f"CNNDuelingQNetwork expects 3D channel-first observations, got {self.obs_shape!r}")
        ...
        self.advantage_head = nn.Linear(head_input_dim, self.action_dim)
