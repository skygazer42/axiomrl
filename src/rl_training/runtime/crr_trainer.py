...
from rl_training.algorithms.crr import CRR
...
def train_crr(
    ...
    *,
    ...
    session = create_training_session(config, algorithm="crr", run_suffix=run_suffix, callbacks=callbacks)
        ...
        while global_step < config.total_timesteps and not trainer_state.should_stop:
            ...
            metrics = {
                **latest_update_metrics,
                ...
                "beta": float(beta),
                "n_action_samples": float(n_action_samples),
