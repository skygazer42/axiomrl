...
from rl_training.algorithms.cal_ql import CalQL
...
def train_cal_ql(
    ...
    *,
    ...
    session = create_training_session(config, algorithm="cal_ql", run_suffix=run_suffix, callbacks=callbacks)
    ...
    try:
        ...
        dataset = _build_offline_dataset(config, action_space=action_space).with_discounted_returns_to_go(gamma=gamma)
