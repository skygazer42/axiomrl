...
from axiomrl.algorithms.edac import EDAC
...
def train_edac(
    ...
    *,
    ...
    session = create_training_session(config, algorithm="edac", run_suffix=run_suffix, callbacks=callbacks)
