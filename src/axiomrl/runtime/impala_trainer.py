...
from axiomrl.algorithms.impala import IMPALA
...
def _build_policy(
    ...
    if len(obs_shape) == 1:
        ...
        return MLPActorCritic(obs_dim=obs_shape[0], action_dim=action_dim, hidden_sizes=hidden_sizes)
...
def train_impala(
    ...
    *,
    ...
    session = create_training_session(config, algorithm="impala", run_suffix=run_suffix, callbacks=callbacks)
