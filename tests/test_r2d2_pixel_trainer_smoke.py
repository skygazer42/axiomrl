...
def test_train_r2d2_supports_image_observations(tmp_path: Path, monkeypatch) -> None:
    ...
    result = get_algorithm_spec(config.algo).train_fn(config, run_suffix="r2d2-pixel-smoke")
