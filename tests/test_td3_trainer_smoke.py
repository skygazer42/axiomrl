...
import axiomrl.runtime.td3_trainer as td3_trainer
...
def test_train_td3_supports_local_async_backend(tmp_path: Path) -> None:
    config = TrainConfig(
        algo="td3",
        env_id="Pendulum-v1",
        seed=179,
    ...
    result = train_td3(config, run_suffix="async-smoke")
